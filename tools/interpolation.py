            ...
            if n_frame > n_min:
                ...
                if num_dti > 0:
                    ...
                    for n in range(num_dti):
                        ...
                        data_dti[n,
                                 2:6] = frames_dti[list(frames_dti.keys())[n]]
...
if __name__ == '__main__':
    data_root = '/home/guest/XieBailian/proj/ByteTrack/datasets/mot/test'
    txt_path = '/home/guest/XieBailian/proj/ByteTrack/YOLOX_outputs/yolox_x_mix_det/track_results'
    save_path = '/home/guest/XieBailian/proj/ByteTrack/YOLOX_outputs/yolox_x_mix_det/track_results_dti'
